...
const getPga = (req, res) => {
  ...
  db.select('player.playerid', 'player.playername')
    ...
    .join('teammatchplayer', function () {
      this.on('pts.playerid', '=', 'teammatchplayer.playerid').andOn(
        'pts.teamid',
        '=',
        'teammatchplayer.teamid',
      )
    })
...
const getScorers = (req, res) => {
  ...
  db.select('player.playerid', 'player.playername', 'team.teamname')
